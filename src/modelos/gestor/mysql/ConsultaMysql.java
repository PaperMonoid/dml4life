...
public class ConsultaMysql implements IConsulta {
    ...
    public ConsultaMysql(Connection conexion, String baseDeDatos, String tabla) {
    ...
    @Override
    public ConsultaMysql agregarCampo(String campo, String alias) {
        this.campos.add(String.format("%s AS %s", campo, alias));
        return this;
    }
